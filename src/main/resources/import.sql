-- insert into student(id,name,surname,age,description) values(nextval('student_seq'),'Gino','Rossi',21,'studente in cerca di ripetizioni')
-- insert into student(id,name,surname,age,description) values(nextval('student_seq'),'Dino','Verdi',18,'studente in cerca di ripetizioni')
